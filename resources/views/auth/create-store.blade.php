                ...
                <div class="h-100 no-gutters row">
                    <div class="h-100 d-md-flex d-sm-block bg-white justify-content-center align-items-center col-md-12 col-lg-7">
                        <div class="mx-auto app-login-box col-sm-12 col-md-10 col-lg-9">
                            ...
                            <h4>
                                <div>Welcome,</div>
                                <span>It only takes a <span class="text-success">few seconds</span> to create your Store</span>
                            </h4>
                            <div>
                              @if ($errors->any())
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="position-relative form-group">
                                                <label for="name" class=""><span class="text-danger">*</span> Owner Name</label>
										...
										<div class="col-md-9">
											<div class="position-relative form-group">
												<label for="store_title" class="">Store Name</label>
												<input name="store_title" id="store_title" placeholder="Type here..." type="text" class="form-control">
												<div class="validation-div val-store_title"></div>
											</div>
										</div>
                                    </div>
									<div class="form-row">	
                    ...
                    <div class="d-lg-flex d-xs-none col-lg-5 hidden-xs">
                                ...
                                <div>
                                    <div class="position-relative h-100 d-flex justify-content-center align-items-center bg-premium-dark"
                                        ...
                                        <div class="slider-content">
                                            ...
                                            <p>Register for lightning fast delivery to your customers</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
