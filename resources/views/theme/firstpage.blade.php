...
.hero-section {
  background-image: url('{{ asset('themeAssets/images/mainbanner_enhanced.jpg') }}'); /* Background image */
  background-size: cover; /* Ensure the image covers the section */
...
<nav class="bg-white shadow-md py- 9 flex justify-between">
  <div class="text-2xl font-bold flex items-center">
    <img src="{{ asset('themeAssets/images/logo.svg') }}" alt="Bright Matrimony Logo" class="mr-3 logo-img" style="height: 4rem; margin-top: 0rem; margin-left: 12px;">
  </div>
...
<form class="w-full max-w-6xl p-6">    <!-- Looking For and Age From/To in the same row -->
    ...
    <section class="py-8 px-4" style="background-color: #f9f0f0;"> <!-- Reduced padding on the section -->
      <div class="max-w-screen-xl mx-auto text-center">
          ...
          <div class="mb-4">
              <img src="{{ asset('themeAssets/images/title-border.svg') }}" alt="Title Border" class="mx-auto w-full max-w-[50%] h-auto"> <!-- Reduced width of title border -->
          </div>
          ...
          <div class="flex flex-col md:flex-row justify-between gap-1"> <!-- Reduced gap between boxes -->
              ...
              <div class="flex flex-col items-center bg-white p-2 rounded-lg shadow-lg border border-gray-300 w-full md:w-1/4 mb-2 h-[12%]"> <!-- Reduced padding, margin, and height -->
                  <img src="{{ asset('themeAssets/images/feature-01.svg') }}" alt="Service 1" class="w-10 h-10 rounded-full object-cover mb-2 border-4 border-beige"> <!-- Reduced image size -->
              ...
              <!-- Service 2 -->
              <div class="flex flex-col items-center bg-white p-2 rounded-lg shadow-lg border border-gray-300 w-full md:w-1/4 mb-2 h-[12%]"> <!-- Reduced padding, margin, and height -->
                  <img src="{{ asset('themeAssets/images/feature-02.svg') }}" alt="Service 2" class="w-10 h-10 rounded-full object-cover mb-2 border-4 border-beige"> <!-- Reduced image size -->
              ...
              <!-- Service 3 -->
              <div class="flex flex-col items-center bg-white p-2 rounded-lg shadow-lg border border-gray-300 w-full md:w-1/4 mb-2 h-[12%]"> <!-- Reduced padding, margin, and height -->
                  <img src="{{ asset('themeAssets/images/feature-03.svg') }}" alt="Service 3" class="w-10 h-10 rounded-full object-cover mb-2 border-4 border-beige"> <!-- Reduced image size -->
    ...
    <section class="py-4 px-8 bg-[#f5f5dc]">
        <div class="max-w-screen-xl mx-auto text-center">
            <!-- Title Border Image -->
            <div class="mb-4">
                <img src="{{ asset('themeAssets/images/title-border.svg') }}" alt="Title Border" class="mx-auto w-full max-w-[50%] h-auto">
            </div>
...
<section class="py-6 px-6" style="background-color:#f9f0f0;">
  <div class="max-w-screen-xl mx-auto flex flex-col lg:flex-row justify-between items-center gap-4">
      ...
      <div class="flex-1 w-full lg:w-2/5">
          <img src="{{ asset('themeAssets/images/chose.png') }}" alt="Why Choose Us" class="w-56 h-40 object-cover rounded-md mx-auto">
      </div>
