...
@section('content')
			...
			<div class="page-title-heading">
				<div>
					<div class="page-title-head center-elem">
						...
						<span class="d-inline-block">Languages</span>
					</div>
				</div>
			</div>
				...
				<div class="page-title-subheading opacity-10">
					<nav class="" aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a>Languages</a></li>
						</ol>
					</nav>
				</div>
			</div>
	...
	<div class="main-card mb-3 card">
		<div class="card-header-tab card-header">
			<div class="card-header-title font-size-lg text-capitalize font-weight-normal">language List</div>
			<div class="btn-actions-pane-right text-capitalize">
				...
				<a class="btn-wide btn-outline-2x mr-md-2 btn btn-outline-focus btn-sm" href="{{ route('languages.create') }}">Add New</a>
			</div>
		</div>
		<div class="card-body">
...
<script>
	...
	$(document).ready(function(e) {
		...
		$(document).on('change','.change_status',function(){
			...
			var response = adminAjax('{{route("ajax.change.language.status")}}', data);
	...
	function getData(){
		...
		var response = adminAjax('{{route("ajax.language.list")}}', data);
	...
	function deleteThis(item_id = ''){
		...
		if(confirm("Are you sure you want to delete this")){
            ...
            var response = adminAjax('{{route("ajax.delete.language")}}', data);
