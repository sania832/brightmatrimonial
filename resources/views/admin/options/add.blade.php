				...
				<div class="page-title-heading">
					<div>
						<div class="page-title-head center-elem">
							...
							<span class="d-inline-block">{{ trans('options.create') }}</span>
						</div>
					</div>
				</div>
					...
					<div class="page-title-subheading opacity-10">
						<nav class="" aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="active breadcrumb-item" aria-current="page">{{ trans('options.add') }}</li>
							</ol>
						</nav>
					</div>
				</div>
					...
					<div class="form-row">
						<div class="col-md-6">
							<div class="position-relative form-group">
								...
								<input id="title" type="text" class="form-control" placeholder="{{ trans('options.placeholder.title') }}">
					...
					<div class="form-row">
						<div class="col-md-4">
							<div class="position-relative form-group">
								...
								<input id="slug" type="text" class="form-control" placeholder="{{ trans('options.placeholder.slug') }}">
  	...
  	function saveData(){
        ...
        response.then(function (value) {
            if(value.status == '200'){
			    ...
			    setTimeout(function(){
                    window.location.href = "{{ route('optionPage', [$type]) }}";
                }, 2000);
